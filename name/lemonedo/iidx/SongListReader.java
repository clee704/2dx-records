...
public class SongListReader {
    ...
    public static List<Song> read(InputStream in) throws IOException {
    ...
    private static Song parseSong(String[] args, Song another) {
        return new Song(args[0], args[1], args[2], args[16].equals("yes"),
                ...
                parseInt(args[10]), parseInt(args[12]),
                parseInt(args[14]), parseInt(args[5]),
                parseInt(args[7]), parseInt(args[9]),
                parseInt(args[11]), parseInt(args[13]),
                parseInt(args[15]), another);        
    }
}
